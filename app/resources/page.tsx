...
const articles = [
  ...
  { slug: 'hers-vs-ecc-rater', title: 'HERS Rater or ECC Rater? Same Role, New Name', excerpt: 'HERS and ECC raters are the same certified field verifier — the 2025 energy code renamed the program. Which term applies depends on your permit. Plus the distinction that does matter: the ECC Writer versus the rater.', tags: ['HERS', 'ECC'] },
